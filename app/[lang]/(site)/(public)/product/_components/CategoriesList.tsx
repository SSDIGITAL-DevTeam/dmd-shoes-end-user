...
const aggregateParentCount = (parent: Category, children: Category[]): number => {
  ...
  // Gunakan nilai maksimum antara parent count dan children total
  // karena parent count biasanya sudah termasuk semua children
  return Math.max(parentCount, childTotal);
};
...
export default function CategoriesList({
  ...
  // Hitung total dari kategori root (parent) saja untuk menghindari double counting
  // Karena parent count sudah include children
