...
import FilterUkuran from "./FilterUkuran";
...
export default function ProductPage({ dictionaryProduct }: { dictionaryProduct: any }) {
      ...
      <Container className=" py-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center mb-6">
          ...
          <div className="w-full lg:w-auto flex justify-between lg:w-1/2 ">
            ...
            <h1 className="text-[16px] lg:text-[40px] font-semibold text-gray-800 text-primary">
            ...
            <div className="w-full lg:w-auto  order-2 lg:order-1 flex space-x-[15px]">
              ...
              >
                <Image
                  ...
                  height={16}
                />
                <span className="font=-medium font-[28px] leading-[150%]">
        ...
        <div className="flex gap-6">
          ...
          <aside
            className={`fixed top-0 right-0 h-full w-[320px] bg-white p-[32px] space-y-[16px]
                        ...
                        duration-300 ${openCategory ? "translate-x-0" : "translate-x-full"}`}
          >
          ...
          {/* sidebar desktop */}
          <aside className="w-64  hidden lg:block bg-white px-[32px] py-[24px] space-y-[16px]  rounded-[8px] ">
            <div>
              <h3
                className={`${lato.className} text-lg text-primary font-semibold mb-3 lg:text-black`}
              >
                {dictionaryProduct?.productCategory || "Kategori Produk"}
              </h3>
            </div>

            <CategoriesList categories={categories} dict={dictionaryProduct}></CategoriesList>
          </aside>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2">
              {products
                ...
                .map((product) => (
                  ...
                  //     <p className=" ">
                  //       <span className="font-semibold text-[#121212] font-[24px] leading-[130%]">
                  //         {" "}
                  //         Rp {product.price.toLocaleString("id-ID")} /
                  //       </span>
                  //       <span className=" text-[#121212] font-[20px] leading-[130%]">
                  //         pasang
                  //       </span>
                  //     </p>
                  //   </div>
